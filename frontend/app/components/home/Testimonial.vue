  ...
  >
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
      ...
      <div class="flex items-center justify-center gap-3 mb-14">
        ...
        <span class="text-orange-500 text-xs font-mono font-medium uppercase tracking-widest">
          Client Stories
        </span>
        <div class="h-px w-12 bg-orange-500 opacity-60" />
      </div>
      ...
      <div class="relative max-w-4xl mx-auto">
        ...
        <div class="overflow-hidden min-h-[320px] lg:min-h-[280px]">
          ...
          >
            <div
              :key="current"
              class="text-center px-4 lg:px-12"
            >
              ...
              <div class="flex items-center justify-center gap-4">
                ...
                <div
                  ...
                  :style="{ backgroundColor: slide.accentColor + '22', border: '1.5px solid ' + slide.accentColor + '55' }"
                  aria-hidden="true"
                >
                  <Icon
        ...
        <!-- Navigation dots -->
        <div class="flex items-center justify-center gap-3 mt-12" role="tablist" aria-label="Testimonial navigation">
          <button
            ...
            :class="i === current ? 'w-10 bg-orange-500' : 'w-4 bg-gray-600 hover:bg-gray-500'"
            @click="goTo(i)"
          />
        </div>
        ...
        <div class="absolute inset-y-0 -left-4 lg:-left-16 flex items-center">
          <button
            ...
            @click="prev"
          >
            <Icon name="lucide:chevron-left" class="w-4 h-4 group-hover:-translate-x-0.5 transition-transform" aria-hidden="true" />
          </button>
        </div>
        <div class="absolute inset-y-0 -right-4 lg:-right-16 flex items-center">
          <button
            ...
            @click="next"
          >
            <Icon name="lucide:chevron-right" class="w-4 h-4 group-hover:translate-x-0.5 transition-transform" aria-hidden="true" />
          </button>
        </div>
      </div>
...
const testimonials = [
  {
    ...
    role: 'Managing Director, Savannah Properties Kenya Ltd',
    initials: 'GW',
  },
  {
    ...
    role: 'Programme Director, Rift Valley Water Foundation',
    initials: 'DK',
  },
  {
    ...
    accentColor: '#B8862E',
    quote: `Our annual conference at Kenyatta International Convention Centre was the most seamless we have ever run — 850 delegates, three stages, zero incidents. Willcoll coordinated every supplier and kept us calm throughout.`,
    name: 'Amina Halima Osman',
    role: 'Head of Corporate Affairs, East Africa Retail Alliance',
    initials: 'AH',
  },
  {
    ...
    name: 'Michael Oduor',
    role: 'Director, TransBorder BookShop Limited',
    initials: 'MO',
  },
]
...
const slide = computed(() => testimonials[current.value] as typeof testimonials[number])
