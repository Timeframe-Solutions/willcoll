...
const testimonials = [
  {
    ...
    accentColor: "#F37321",
    quote: `We had been trying to structure our acquisition for a long time. Willcoll cut through the complexity, advised on the right approach, and made sure every step was solid. We moved forward with confidence.`,
  ...
  },
  {
    ...
    accentColor: "#1E8E5A",
    quote: `We were rolling out a large project when delays started piling up. Willcoll's risk assessment caught issues we had completely missed. That intervention saved us a lot of rework.`,
  ...
  },
  {
    ...
    accentColor: "#B8862E",
    quote: `Our conference was the most seamless we have ever run. Willcoll coordinated every supplier and kept us calm throughout.`,
  ...
  },
  {
    ...
    accentColor: "#2B6CB0",
    quote: `Willcoll helped us navigate media buying in a way our in-house team simply could not. They secured strong airtime for well under what we had budgeted. Our brand awareness picked up fast.`,
    name: "Michael Oduor",
    role: "Director",
    initials: "MO",
  },
