<template>
  <section class="relative z-10 -mt-1" aria-label="Trust and credibility">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
      <div
        class="bg-white border border-gray-100 rounded-xl grid grid-cols-1 lg:grid-cols-3 gap-8 p-8 lg:p-10"
